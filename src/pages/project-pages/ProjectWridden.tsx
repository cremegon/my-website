      ...
      <div className="page-content wridden">
        ...
        <div className="text-content nier">
          ...
          <p>
            ...
            professions and ages. Once the data was collected, personas would be
            formed out of the collective wants, needs and nice-to-haves from the
            interviewee's input and the features of the app would be designed
            around a <span>user-centric methodology</span>. <br />
            <br />
            <span>A problem statement was clearly defined: </span>
            For a novice writer, keeping track of everything in a story can be a
            daunting task, especially in the process of writing. Getting
          ...
          <h2>Technology</h2>
          <p>
            The application was created through the React Native Framework. With
            the primary language being JavaScript & TypeScript alongside a basic
            authentication done through an async backend and SQL.
            <br />
            <br />
          ...
          <p>
            ...
            an inviting app would look like, as well as the ideal and non-ideal
            layout of a "writing-app", the theme of the app was created
            accordingly.
            <br />
            <br />
            <img
          ...
          <p>
            ...
            softer and grey tones, so that the app would be easy on the eye and
            close to the visual association to the users.
            <br />
            <br />
          </p>
          <img
          ...
          <h2>Outcome:</h2>
          <p>
            A functioning mobile app that achieved the design and functionality
            of the project. With the ability to write stories, save them, share
            them and to additionally create character profiles saved seperately,
            so that users could visit old and new characters at a later time to
