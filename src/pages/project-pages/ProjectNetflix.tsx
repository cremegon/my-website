        ...
        <div className="page-content nier">
          ...
          <div className="text-content nier">
            ...
            <p>
              ...
              that the React framework is based on, I decided to challenge
              myself by replicating the netflix landing page using only raw
              JavaScript for functionality.
            </p>
            <h2>Approach:</h2>
            <p>
              I decided to review concepts and the structure of the DOM, in
              order to understand the underlying foundation upon which different
              elements can be targeted. It was also to understand the DOM
              history stack, that controls matters such as routing and data
            ...
            <p>
              ...
              inbuilt functions to get elements and queries from the document,
              we are able to manipulate the behavior of the site by manipulating
              the elements within.
            </p>
            <h2>Outcome:</h2>
            <p>
              A successful replication of the Netflix homepage, that was is
              identical to the original, as well as a newfound solid foundation
